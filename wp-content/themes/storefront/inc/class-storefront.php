...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function scripts() {
			...
			wp_enqueue_style( 'bootstrap-min', get_template_directory_uri() . '/assets/css/bootstrap.min.css', '', $storefront_version );
			wp_enqueue_style( 'styles', get_template_directory_uri() . '/assets/css/styles.css', '', $storefront_version );			
			...
			wp_enqueue_script( 'bootstrap-min', get_template_directory_uri() . '/assets/js/bootstrap' . $suffix . '.js', array(), $storefront_version, true );
			wp_enqueue_script( 'commonscript', get_template_directory_uri() . '/assets/js/commonscript' . '.js', array(), $storefront_version, true );
			wp_enqueue_script( 'wow', get_template_directory_uri() . '/assets/js/wow' . '.js', array(), $storefront_version, true );
