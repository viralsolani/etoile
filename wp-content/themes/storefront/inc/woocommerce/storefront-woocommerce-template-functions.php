...
if ( ! function_exists( 'storefront_header_cart' ) ) {
	...
	function storefront_header_cart() {
		if ( storefront_is_woocommerce_activated() ) {
			...
			?>
		<?php /*<ul id="site-header-cart" class="site-header-cart menu">
			<li class="<?php echo esc_attr( $class ); ?>">
				<?php storefront_cart_link(); ?>
			</li>
			<li>
...
if ( ! function_exists( 'storefront_product_categories' ) ) {
	...
	function storefront_product_categories( $args ) {
		...
		$shortcode_content1 = storefront_do_shortcode(
			'product_categories', apply_filters(
				'storefront_product_categories_shortcode_args', array(
					'number'  => 2,
					'columns' => 2,
		 ...
		 * Only display the section if the shortcode returns product categories
		 */
		if ( false !== strpos( $shortcode_content1, 'product-category' ) ) {
			echo '<section class="storefront-product-section storefront-product-categories" aria-label="' . esc_attr__( 'Product Categories 1', 'storefront' ) . '">';
			...
			echo $shortcode_content1; // WPCS: XSS ok.
	...
	function storefront_best_selling_products( $args ) {
		$args = apply_filters(
			'storefront_best_selling_products_args', array(
				...
				'orderby' => 'rating',
				'order'   => 'desc',
				'title'   => esc_attr__( 'Featured Products', 'storefront' ),
			)
		);
		 ...
		 */
		if ( false !== strpos( $shortcode_content, 'product' ) ) {
			echo '<section class="storefront-product-section storefront-best-selling-products" aria-label="' . esc_attr__( 'Featured Products', 'storefront' ) . '">';
...
if ( ! function_exists( 'storefront_single_product_pagination' ) ) {
	...
	function storefront_single_product_pagination() {
		...
		?>
		<?php /*<nav class="storefront-product-pagination" aria-label="<?php esc_attr_e( 'More products', 'storefront' ); ?>">
