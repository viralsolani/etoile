...
<div id="page" class="hfeed site">
			...
			<div class="col-full">
				...
				<div class="top-socialicon pull-right">
					<ul>
					  ...
					  <li><a href="login" title="Login" class="phoen-login-signup-popup-open">Login</a></li>					  
					</ul>
				</div>
			</div>
		</div>
	...
	<div id="content" class="site-content" tabindex="-1">
	   <div id="slider-div"> <?php if(is_front_page()){ echo do_shortcode('[metaslider id="92"]'); }   ?>  </div>
		<div class="col-full">
