                    	...
                    	<div class="row">
							...
							<div class="col-xs-12 col-sm-12">
                                <div class="contact_addres_box contact_email_box">
                                    ...
                                    <p><a title="info@test.com.au" href="mailto:info@etoilefashion.com">info@etoilefashion.com</a></p>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12">
                                <div class="contact_addres_box contact_call_box">
                                    <span class="call-icon"><i class="fa fa-phone"></i></span>
                                    <p><a class="click-call" title="123456789" href="tel:+91-963-235-7648">+91-963-235-7648</a></p>
                                </div>
                            </div>
